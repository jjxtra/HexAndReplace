...
Compress-Archive -Path "./bin/release/net8.0/publish/win-x64/HexAndReplace.exe" -DestinationPath "./bin/release/net8.0/publish/win-x64/HexAndReplace.zip" -CompressionLevel Optimal
...
# zip the output exe with max compression
Compress-Archive -Path "./bin/release/net8.0/publish/linux-x64/HexAndReplace" -DestinationPath "./bin/release/net8.0/publish/linux-x64/HexAndReplace.zip" -CompressionLevel Optimal
